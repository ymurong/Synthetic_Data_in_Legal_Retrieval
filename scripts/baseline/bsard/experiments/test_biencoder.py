...
if __name__ == '__main__':
    ...
    # 2. Load the test set.
    test_queries_df = pd.read_csv(abspath(join(__file__, "../../../data/bsard/questions_fr_test.csv")))
    documents_df = pd.read_csv(abspath(join(__file__, "../../../data/bsard/articles_fr.csv")))
